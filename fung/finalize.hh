...
namespace FunG
{
  ...
  namespace Detail
  {
    ...
    struct FinalizeImpl : F
    {
      ...
      {
        static_assert( Checks::Has::variableId< F, id >(), "You are trying to compute the first derivative with respect to a variable that is not present" );
        static_assert( Checks::checkArgument<F,Arg,id>(), "Incompatible argument in computation of first derivative." );
        static_assert( Checks::Has::consistentFirstDerivative< F >(), "Inconsistent functional definition encountered.");

        return FinalizeD1< id, ReturnType, Checks::Has::MemFn::d1< F, IndexedType<Arg,id> >::value>()(static_cast<const F&>(*this),dx);
      }
      ...
      ReturnType d1() const
      {
        ...
        return FinalizeD1< id, ReturnType, Checks::Has::MemFn::d1< F, IndexedType<Arg,id> >::value>()(static_cast<const F&>(*this),Arg(1));
      }

      template < int idx, int idy, class ArgX, class ArgY >
      ReturnType d2(const ArgX& dx, const ArgY& dy) const
      {
        static_assert( Checks::Has::variableId< F, idx >() && Checks::Has::variableId< F, idy>(),
        ...
        static_assert( Checks::Has::consistentSecondDerivative< F, IndexedType<ArgX,idx>, IndexedType<ArgY,idy> >(), "Inconsistent functional definition encountered." );

        return FinalizeD2< idx, idy, ReturnType, Checks::Has::MemFn::d2< F, IndexedType<ArgX,idx>, IndexedType<ArgY,idy> >::value>()(static_cast<const F&>(*this),dx,dy);
      }
      ...
      ReturnType d2() const
      {
        ...
        return FinalizeD2< idx, idy, ReturnType, Checks::Has::MemFn::d2< F, IndexedType<ArgX,idx>, IndexedType<ArgY,idy> >::value>()(static_cast<const F&>(*this),ArgX(1),ArgY(1));
      }

      template < int idx, int idy, int idz, class ArgX, class ArgY, class ArgZ >
      ReturnType d3(const ArgX& dx, const ArgY& dy, const ArgZ& dz) const
      {
        static_assert( Checks::Has::variableId< F, idx >() && Checks::Has::variableId< F, idy>() && Checks::Has::variableId< F, idz >(),
        ...
        static_assert(Checks::Has::consistentThirdDerivative< F, IndexedType<ArgX,idx>, IndexedType<ArgY,idy>, IndexedType<ArgZ,idz> >(), "Inconsistent functional definition encountered.");

        return FinalizeD3< idx, idy, idz, ReturnType ,
                           Checks::Has::MemFn::d3< F, IndexedType<ArgX,idx>, IndexedType<ArgY,idy>, IndexedType<ArgZ,idz> >::value>()(static_cast<const F&>(*this),dx,dy,dz);
      }
      ...
      ReturnType d3() const
      {
        ...
        return FinalizeD3< idx, idy, idz, ReturnType ,
                           Checks::Has::MemFn::d3< F, IndexedType<ArgX,idx>, IndexedType<ArgY,idy>, IndexedType<ArgZ,idz> >::value>()(static_cast<const F&>(*this),ArgX(1),ArgY(1),ArgZ(1));
      }
    };
    ...
    struct FinalizeImpl<F,false> : F
    {
      ...
      {
        static_assert( Checks::Has::consistentFirstDerivative< F >(), "Inconsistent functional definition encountered." );
        return FinalizeD1< 0, ReturnType, Checks::Has::MemFn::d1< F, IndexedType<Arg,0> >::value >()(static_cast<const F&>(*this),dx);
      }

      template < class ArgX, class ArgY >
      ReturnType d2(const ArgX& dx, const ArgY& dy) const
      {
        static_assert( Checks::Has::consistentSecondDerivative< F, IndexedType<ArgX,0>, IndexedType<ArgY,0> >(), "Inconsistent functional definition encountered." );
        return FinalizeD2< 0, 0, ReturnType, Checks::Has::MemFn::d2< F, IndexedType<ArgX,0>, IndexedType<ArgY,0> >::value >()(static_cast<const F&>(*this),dx,dy);
      }

      template < class ArgX, class ArgY, class ArgZ >
      ReturnType d3(const ArgX& dx, const ArgY& dy, const ArgZ& dz) const
      {
        static_assert( Checks::Has::consistentThirdDerivative< F, IndexedType<ArgX,0>, IndexedType<ArgY,0>, IndexedType<ArgZ,0> >(), "Inconsistent functional definition encountered." );
        return FinalizeD3< 0, 0, 0, ReturnType ,
                           Checks::Has::MemFn::d3< F, IndexedType<ArgX,0>, IndexedType<ArgY,0>, IndexedType<ArgZ,0> >::value >()(static_cast<const F&>(*this),dx,dy,dz);
      }
    };
  }
  /// @endcond
