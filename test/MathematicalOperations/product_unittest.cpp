...
{
  using RFFGen::CMath::Pow;
  auto fun = RFFGen::finalize_scalar( Pow<1,2>(4.) * Pow<3,2>(4.) );
...
{
  using RFFGen::CMath::Pow;
  auto fun = RFFGen::finalize_scalar( Pow<1,2>(5.) * Pow<3,2>(5.) );
...
{
  using RFFGen::CMath::Pow;
  auto fun = RFFGen::finalize_scalar( Pow<1,2>(3.) * Pow<3,2>(3.) );
