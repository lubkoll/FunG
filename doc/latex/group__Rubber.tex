...
\index{Rubber@{Rubber}!compressible\+Mooney\+Rivlin@{compressible\+Mooney\+Rivlin}}
\index{compressible\+Mooney\+Rivlin@{compressible\+Mooney\+Rivlin}!Rubber@{Rubber}}
\subsubsection[{\texorpdfstring{compressible\+Mooney\+Rivlin(double c0, double c1, double d0, double d1, const Matrix \&\+F)}{compressibleMooneyRivlin(double c0, double c1, double d0, double d1, const Matrix &F)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Inflation\+Penalty , class Compression\+Penalty , class Matrix , int n = Linear\+Algebra\+::dim$<$\+Matrix$>$()$>$ auto Fun\+G\+::compressible\+Mooney\+Rivlin (
...
)}\hypertarget{group__Rubber_ga9a1894daa10a0bdcc620c6c41ecb6f19}{}\label{group__Rubber_ga9a1894daa10a0bdcc620c6c41ecb6f19}
...
\index{Rubber@{Rubber}!compressible\+Neo\+Hooke@{compressible\+Neo\+Hooke}}
\index{compressible\+Neo\+Hooke@{compressible\+Neo\+Hooke}!Rubber@{Rubber}}
\subsubsection[{\texorpdfstring{compressible\+Neo\+Hooke(double c, double d0, double d1, const Matrix \&\+F)}{compressibleNeoHooke(double c, double d0, double d1, const Matrix &F)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Inflation\+Penalty , class Compression\+Penalty , class Matrix , int n = Linear\+Algebra\+::dim$<$\+Matrix$>$()$>$ auto Fun\+G\+::compressible\+Neo\+Hooke (
\begin{DoxyParamCaption}
\item[{double}]{c, }
\item[{double}]{d0, }
\item[{double}]{d1, }
\item[{const Matrix \&}]{F}
\end{DoxyParamCaption}
)}\hypertarget{group__Rubber_gac5c39cd9de55f4f0220a806cf28a7b30}{}\label{group__Rubber_gac5c39cd9de55f4f0220a806cf28a7b30}
...
\index{Rubber@{Rubber}!incompressible\+Mooney\+Rivlin@{incompressible\+Mooney\+Rivlin}}
\index{incompressible\+Mooney\+Rivlin@{incompressible\+Mooney\+Rivlin}!Rubber@{Rubber}}
\subsubsection[{\texorpdfstring{incompressible\+Mooney\+Rivlin(double c0, double c1, const Matrix \&\+F)}{incompressibleMooneyRivlin(double c0, double c1, const Matrix &F)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Matrix , int n = Linear\+Algebra\+::dim$<$\+Matrix$>$()$>$ auto Fun\+G\+::incompressible\+Mooney\+Rivlin (
\begin{DoxyParamCaption}
\item[{double}]{c0, }
\item[{double}]{c1, }
\item[{const Matrix \&}]{F}
\end{DoxyParamCaption}
)}\hypertarget{group__Rubber_gace19173e33490aadd36ae3a03fd1d85c}{}\label{group__Rubber_gace19173e33490aadd36ae3a03fd1d85c}
...
\index{Rubber@{Rubber}!incompressible\+Neo\+Hooke@{incompressible\+Neo\+Hooke}}
\index{incompressible\+Neo\+Hooke@{incompressible\+Neo\+Hooke}!Rubber@{Rubber}}
\subsubsection[{\texorpdfstring{incompressible\+Neo\+Hooke(double c, const Matrix \&\+F)}{incompressibleNeoHooke(double c, const Matrix &F)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Matrix , int n = Linear\+Algebra\+::dim$<$\+Matrix$>$()$>$ auto Fun\+G\+::incompressible\+Neo\+Hooke (
\begin{DoxyParamCaption}
\item[{double}]{c, }
\item[{const Matrix \&}]{F}
\end{DoxyParamCaption}
)}\hypertarget{group__Rubber_ga5bb28aef7006413775791998936d6b81}{}\label{group__Rubber_ga5bb28aef7006413775791998936d6b81}
...
\index{Rubber@{Rubber}!modified\+Compressible\+Neo\+Hooke@{modified\+Compressible\+Neo\+Hooke}}
\index{modified\+Compressible\+Neo\+Hooke@{modified\+Compressible\+Neo\+Hooke}!Rubber@{Rubber}}
\subsubsection[{\texorpdfstring{modified\+Compressible\+Neo\+Hooke(double c, double d0, double d1, const Matrix \&\+F)}{modifiedCompressibleNeoHooke(double c, double d0, double d1, const Matrix &F)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Inflation\+Penalty , class Compression\+Penalty , class Matrix , int n = Linear\+Algebra\+::dim$<$\+Matrix$>$()$>$ auto Fun\+G\+::modified\+Compressible\+Neo\+Hooke (
\begin{DoxyParamCaption}
\item[{double}]{c, }
\item[{double}]{d0, }
\item[{double}]{d1, }
\item[{const Matrix \&}]{F}
\end{DoxyParamCaption}
)}\hypertarget{group__Rubber_gac10942df03f037afdf0a81d330361a6b}{}\label{group__Rubber_gac10942df03f037afdf0a81d330361a6b}
...
\index{Rubber@{Rubber}!modified\+Incompressible\+Neo\+Hooke@{modified\+Incompressible\+Neo\+Hooke}}
\index{modified\+Incompressible\+Neo\+Hooke@{modified\+Incompressible\+Neo\+Hooke}!Rubber@{Rubber}}
\subsubsection[{\texorpdfstring{modified\+Incompressible\+Neo\+Hooke(double c, const Matrix \&\+F)}{modifiedIncompressibleNeoHooke(double c, const Matrix &F)}}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Matrix , int n = Linear\+Algebra\+::dim$<$\+Matrix$>$()$>$ auto Fun\+G\+::modified\+Incompressible\+Neo\+Hooke (
\begin{DoxyParamCaption}
\item[{double}]{c, }
\item[{const Matrix \&}]{F}
\end{DoxyParamCaption}
)}\hypertarget{group__Rubber_gaf6f5ab6a379ef03d513acc5042731a01}{}\label{group__Rubber_gaf6f5ab6a379ef03d513acc5042731a01}
