...
$A+A^T$ 
\end{DoxyReturn}
\hypertarget{namespaceRFFGen_a181c95df45572198e3e6bcac7616cd68}{\index{R\-F\-F\-Gen@{R\-F\-F\-Gen}!constant@{constant}}
\index{constant@{constant}!RFFGen@{R\-F\-F\-Gen}}
\subsubsection[{constant}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Arg $>$ auto R\-F\-F\-Gen\-::constant (
\begin{DoxyParamCaption}
\item[{const Arg \&}]{x}
\end{DoxyParamCaption}
)}}\label{namespaceRFFGen_a181c95df45572198e3e6bcac7616cd68}
...
Adds the definition of possibly undefined vanishing higher order derivatives. \hypertarget{namespaceRFFGen_ab537e59af6c5a4f0f2a7469e8ae6461b}{\index{R\-F\-F\-Gen@{R\-F\-F\-Gen}!operator$\ast$@{operator$\ast$}}
\index{operator$\ast$@{operator$\ast$}!RFFGen@{R\-F\-F\-Gen}}
\subsubsection[{operator$\ast$}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class F , class G , class  = std\-::enable\-\_\-if\-\_\-t$<$ std\-::is\-\_\-base\-\_\-of$<$\-Base,\-F$>$\-::value $\vert$$\vert$ std\-::is\-\_\-base\-\_\-of$<$\-Base,\-G$>$\-::value $>$$>$ auto R\-F\-F\-Gen\-::operator$\ast$ (
\begin{DoxyParamCaption}
\item[{const F \&}]{f, }
\item[{const G \&}]{g}
\end{DoxyParamCaption}
)}}\label{namespaceRFFGen_ab537e59af6c5a4f0f2a7469e8ae6461b}
...
This is not to be confused with delayed computations with expression templates. This operator is only used to admit intuitive definition of functions. If the resulting type represents a polynomial of order smaller than two, than you need to wrap it into Finalize to generate missing derivatives. \hypertarget{namespaceRFFGen_a59a4ba5900f079a4023c34cd620fc21d}{\index{R\-F\-F\-Gen@{R\-F\-F\-Gen}!operator$^\wedge$@{operator$^\wedge$}}
\index{operator$^\wedge$@{operator$^\wedge$}!RFFGen@{R\-F\-F\-Gen}}
\subsubsection[{operator$^\wedge$}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class F , class  = std\-::enable\-\_\-if\-\_\-t$<$ std\-::is\-\_\-base\-\_\-of$<$\-Base,\-F$>$\-::value $>$$>$ auto R\-F\-F\-Gen\-::operator$^\wedge$ (
\begin{DoxyParamCaption}
\item[{const F \&}]{f, }
\item[{int}]{k}
\end{DoxyParamCaption}
)}}\label{namespaceRFFGen_a59a4ba5900f079a4023c34cd620fc21d}


overload of \char`\"{}$^\wedge$\char`\"{}-\/operator for the generation of functions. 

This is not to be confused with delayed computations with expression templates. This operator is only used to admit intuitive definition of functions. If the resulting type represents a polynomial of order smaller than two, than you need to wrap it into Finalize to generate missing derivatives. \hypertarget{namespaceRFFGen_a63d0192aaeb22d4afe3c2f523524f3ac}{\index{R\-F\-F\-Gen@{R\-F\-F\-Gen}!zero@{zero}}
\index{zero@{zero}!RFFGen@{R\-F\-F\-Gen}}
\subsubsection[{zero}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Matrix , class  = std\-::enable\-\_\-if\-\_\-t$<$\-Checks\-::is\-Constant\-Size\-Matrix$<$\-Matrix$>$()$>$$>$ Matrix R\-F\-F\-Gen\-::zero (
\begin{DoxyParamCaption}
{}
\end{DoxyParamCaption}
)}}\label{namespaceRFFGen_a63d0192aaeb22d4afe3c2f523524f3ac}
...
\end{DoxyReturn}
\hypertarget{namespaceRFFGen_a0ad3b71c6132f265349b58702649eb32}{\index{R\-F\-F\-Gen@{R\-F\-F\-Gen}!zero@{zero}}
\index{zero@{zero}!RFFGen@{R\-F\-F\-Gen}}
\subsubsection[{zero}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Matrix , class  = std\-::enable\-\_\-if\-\_\-t$<$!\-Checks\-::is\-Constant\-Size\-Matrix$<$\-Matrix$>$()$>$$>$ constexpr Matrix R\-F\-F\-Gen\-::zero (
\begin{DoxyParamCaption}
\item[{int}]{rows, }
\item[{int}]{cols}
\end{DoxyParamCaption}
)}}\label{namespaceRFFGen_a0ad3b71c6132f265349b58702649eb32}
Requires that a specialization of struct \hyperlink{structRFFGen_1_1Zero}{Zero} exists for Matrix. \begin{DoxyReturn}{Returns}
