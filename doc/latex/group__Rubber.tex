...
\subsubsection[{compressible\-Mooney\-Rivlin}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Inflation\-Penalty , class Compression\-Penalty , class Matrix , int n = \-Linear\-Algebra\-::dim$<$\-Matrix$>$()$>$ auto {\bf \-Fun\-G\-::compressible\-Mooney\-Rivlin} (
...
\subsubsection[{compressible\-Neo\-Hooke}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Inflation\-Penalty , class Compression\-Penalty , class Matrix , int n = \-Linear\-Algebra\-::dim$<$\-Matrix$>$()$>$ auto {\bf \-Fun\-G\-::compressible\-Neo\-Hooke} (
\begin{DoxyParamCaption}
\item[{double}]{c, }
\item[{double}]{d0, }
\item[{double}]{d1, }
...
\subsubsection[{incompressible\-Mooney\-Rivlin}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Matrix , int n = \-Linear\-Algebra\-::dim$<$\-Matrix$>$()$>$ auto {\bf \-Fun\-G\-::incompressible\-Mooney\-Rivlin} (
\begin{DoxyParamCaption}
\item[{double}]{c0, }
\item[{double}]{c1, }
\item[{const \-Matrix \&}]{\-F}
...
\subsubsection[{incompressible\-Neo\-Hooke}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Matrix , int n = \-Linear\-Algebra\-::dim$<$\-Matrix$>$()$>$ auto {\bf \-Fun\-G\-::incompressible\-Neo\-Hooke} (
\begin{DoxyParamCaption}
\item[{double}]{c, }
\item[{const \-Matrix \&}]{\-F}
\end{DoxyParamCaption}
...
\subsubsection[{modified\-Compressible\-Neo\-Hooke}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Inflation\-Penalty , class Compression\-Penalty , class Matrix , int n = \-Linear\-Algebra\-::dim$<$\-Matrix$>$()$>$ auto {\bf \-Fun\-G\-::modified\-Compressible\-Neo\-Hooke} (
\begin{DoxyParamCaption}
\item[{double}]{c, }
\item[{double}]{d0, }
\item[{double}]{d1, }
...
\subsubsection[{modified\-Incompressible\-Neo\-Hooke}]{\setlength{\rightskip}{0pt plus 5cm}template$<$class Matrix , int n = \-Linear\-Algebra\-::dim$<$\-Matrix$>$()$>$ auto {\bf \-Fun\-G\-::modified\-Incompressible\-Neo\-Hooke} (
\begin{DoxyParamCaption}
\item[{double}]{c, }
\item[{const \-Matrix \&}]{\-F}
\end{DoxyParamCaption}
