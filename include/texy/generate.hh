...
namespace texy
{
    ...
    {
        template < class F0, class G0, bool = FunG::Checks::isFunction< std::decay_t< F0 > >(),
     ...
     */
    template < class F,
               std::enable_if_t< FunG::Checks::isFunction< std::decay_t< F > >() >* = nullptr >
    ...
    //                       "Independent variables can not be on the left side of the chain
    //                       operator." );
