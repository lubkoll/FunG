...
#ifndef RFFGEN_PERFORMANCE_TEST_EXAMPLE_TEST_HH
#define RFFGEN_PERFORMANCE_TEST_EXAMPLE_TEST_HH
...
void testExamples_Armadillo()
{
  ...
  auto incompressibleNeoHooke = RFFGen::incompressibleNeoHooke<M,3>(c0,I);
  auto incompressibleModifiedNeoHooke = RFFGen::modifiedIncompressibleNeoHooke<M,3>(c0,I);
...
#endif /* RFFGEN_PERFORMANCE_TEST_EXAMPLE_TEST_HH */
