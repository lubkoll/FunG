...
#ifndef RFFGEN_LINEAR_ALGEBRA_COFACTOR_HH
  ...
  namespace LinearAlgebra
  {
    ...
    namespace Detail
    {
      ...
      auto computeCofactorImpl(Matrix const&, Matrix const& A, std::integral_constant<int,2>)
      {
        ...
        return sign(row,col) * A[Id::firstRow][Id::firstCol];
      }
     ...
     */
    template < int row , int col , class Matrix , class = Concepts::MatrixConceptCheck<Matrix> >
